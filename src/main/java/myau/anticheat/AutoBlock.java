...
public class Autoblock extends Module {
    ...
    public final SliderSetting  legitfullHoldMin    = register(new SliderSetting("LF Hold Min",    3.0,  1.0, 10.0, 0.5, () -> mode.getIndex() == 11));
    public final SliderSetting  legitfullHoldMax    = register(new SliderSetting("LF Hold Max",    6.0,  1.0, 10.0, 0.5, () -> mode.getIndex() == 11));
    public final SliderSetting  legitfullDelayMin   = register(new SliderSetting("LF Delay Min",   2.0,  0.0,  8.0, 0.5, () -> mode.getIndex() == 11));
    public final SliderSetting  legitfullDelayMax   = register(new SliderSetting("LF Delay Max",   4.0,  0.0,  8.0, 0.5, () -> mode.getIndex() == 11));
