...
/**
 * AimAssist — Uses KillAura's silent aim/dynamic rotation logic
 */
public class AimAssist extends Module {
    ...
    // ── Silent: dynamic rotations via RotationState (from KillAura) ──────
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        // Apply silent rotation (same as KillAura)
